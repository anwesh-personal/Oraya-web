    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-[var(--surface-50)] border border-[var(--surface-200)]">
                <h3 className="text-lg font-semibold text-[var(--surface-900)] mb-6">Revenue Trend</h3>
            ...
            {/* Users by Tier */}
            <div className="p-6 rounded-2xl bg-[var(--surface-50)] border border-[var(--surface-200)]">
                <h3 className="text-lg font-semibold text-[var(--surface-900)] mb-6">Users by Tier</h3>
                <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                        <Pie
                        ...
                        />
                        <Legend
                            formatter={(value) => <span className="text-[var(--surface-600)]">{value}</span>}
                        />
                    </PieChart>
                </ResponsiveContainer>
            </div>
            ...
            {/* Feature Usage */}
            <div className="p-6 rounded-2xl bg-[var(--surface-50)] border border-[var(--surface-200)] lg:col-span-2">
                <h3 className="text-lg font-semibold text-[var(--surface-900)] mb-6">Top Features by Usage</h3>
                <ResponsiveContainer width="100%" height={300}>
