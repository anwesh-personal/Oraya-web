            ...
            <div className="max-w-[1400px] mx-auto px-6 relative z-20">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-7 space-y-8 text-left">
                        ...
                        >
                            &quot;I was tired of <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00F0FF] via-white to-[#FF00AA] animate-gradient-x bg-[length:200%_auto]">using tools</span> <br />
                        ...
                        >
                            <p className="text-lg md:text-xl text-zinc-400 font-sans font-light leading-relaxed max-w-xl">
                                Oraya wasn&apos;t built in a marketing meeting. It was forged in the dark by engineers who needed a way to unify high-intensity logic with absolute hardware privacy. We didn&apos;t build a chatbot; we built a second brain.
                            </p>
                            ...
                            <div className="relative pl-8 py-4 border-l-2 border-[#00F0FF]/30 space-y-2">
                                <p className="text-xl md:text-2xl text-white font-sans font-black tracking-tight leading-tight italic">
                                    &quot;Absolute hardware dominion is the only way to win.&quot;
                                </p>
                            </div>
                        </motion.div>
                    </div>
