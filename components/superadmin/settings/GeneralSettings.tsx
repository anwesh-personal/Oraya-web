    ...
    const loadSettings = useCallback(async () => {
        ...
        try {
            const [genRes, sysRes, brandRes, supRes] = await Promise.all([
                fetch("/api/superadmin/settings?category=general"),
                fetch("/api/superadmin/settings?category=system"),
                fetch("/api/superadmin/settings?category=branding"),
                fetch("/api/superadmin/settings?category=support"),
            ]);
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 rounded-xl text-white font-medium transition-all shadow-lg disabled:opacity-50"
