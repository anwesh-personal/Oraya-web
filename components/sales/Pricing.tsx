            ...
            <div className="max-w-[1400px] mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-24 space-y-8">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="inline-flex items-center gap-4 px-6 py-2 bg-white/[0.02] border border-white/10 rounded-full font-mono text-[10px] font-black uppercase tracking-[0.5em] text-primary"
                    >
                ...
                >
                    <div className="relative p-[1px] rounded-[40px] overflow-hidden bg-gradient-to-b from-white/10 to-transparent">
                        <div className="relative bg-[#080808] rounded-[39px] p-8 md:p-12 overflow-hidden group">
                            ...
                            <div className="flex flex-col md:flex-row gap-12 items-center">
                                <div className="space-y-6 flex-1">
                                    <div className="flex items-center gap-4 text-primary font-mono text-[10px] font-black uppercase tracking-[0.4em]">
                                ...
                                <div className="w-full md:w-[400px] space-y-4">
                                    <div className="bg-black/40 border border-white/5 rounded-3xl p-6 min-h-[120px] flex flex-col justify-end font-mono text-xs">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-6 py-4 font-sans text-sm outline-none focus:border-primary/50 transition-colors pr-16"
                                        />
                                        <button className="absolute right-3 top-1/2 -translate-y-1/2 p-2.5 bg-primary text-black rounded-xl hover:bg-white transition-colors">
                                            <Send size={16} />
                                        </button>
                                    </div>
                                </div>
...
function PricingCard({ plan, index }: { plan: any; index: number }) {
    return (
        <motion.div
            ...
            whileHover={{ y: -10 }}
            className={cn(
                "relative p-8 md:p-12 rounded-[56px] border transition-all duration-700 overflow-hidden flex flex-col h-full",
                plan.popular
                    ? "bg-[#0A0805] border-primary/40 shadow-[0_40px_100px_-20px_rgba(245,158,11,0.15)] ring-1 ring-primary/20 scale-[1.05] z-10 py-16 md:py-20"
        ...
        >
            ...
            <div className="space-y-10 flex-1">
                <div className="space-y-4">
                    <div className="flex justify-between items-start">
                        <h4 className="font-mono text-[10px] font-black uppercase tracking-[0.5em] text-zinc-600">
                            {plan.name}
                        </h4>
                        {plan.popular && (
                            <span className="bg-primary/10 border border-primary/20 text-primary font-mono font-black text-[9px] px-4 py-1.5 rounded-full uppercase tracking-[0.3em] flex items-center gap-2">
                                <Sparkles size={10} />
                                Elite_Choice
                            </span>
                        )}
                ...
                <p className="text-zinc-500 font-sans font-light italic text-base leading-relaxed uppercase tracking-tight">
                    &quot;{plan.desc}&quot;
                </p>
                ...
                <ul className="space-y-5">
                    {plan.features.map((feature: any, j: number) => (
                        <li key={j} className="flex gap-4 items-start group/li">
                            <div className={cn(
                                "shrink-0 w-5 h-5 rounded-full flex items-center justify-center transition-all duration-500",
                                feature.included
                                    ? "bg-primary/10 text-primary group-hover/li:bg-primary group-hover/li:text-black"
                                    : "bg-white/[0.03] text-zinc-700"
                            )}>
                                {feature.included ? <Check size={12} strokeWidth={3} /> : <X size={10} />}
                            </div>
                            <span className={cn(
                                "text-[11px] font-mono uppercase tracking-[0.2em] transition-colors duration-500 pt-0.5",
            ...
            <Link
                ...
                className={cn(
                    "mt-12 w-full py-6 rounded-2xl font-mono font-black text-[10px] uppercase tracking-[0.5em] flex items-center justify-center gap-3 transition-all duration-500 group/btn relative overflow-hidden",
                    plan.popular
