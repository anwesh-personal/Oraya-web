...
const getActionColor = (action: string) => {
    if (action.includes("create") || action.includes("activate")) return "text-emerald-400 bg-emerald-500/10";
    if (action.includes("delete") || action.includes("revoke")) return "text-rose-400 bg-rose-500/10";
    if (action.includes("update")) return "text-amber-400 bg-amber-500/10";
