...
const TRANSFORMATION_DATA = [
    {
        ...
        before: "Manual copy-pasting segments across tabs. Context leaks every 20 minutes.",
        after: "2M+ Token Neural Recall. Permanent project history is locked into the kernel.",
        icon: BrainIcon
    },
    {
        dimension: "Data Sovereignty",
        before: "Broadcasting proprietary IP and API keys to cloud black-boxes.",
        after: "Biological data isolation. Weights and keys live in the local hardware vault.",
        icon: ShieldIcon
    },
    {
        dimension: "Execution Speed",
        before: "Waiting 5 seconds for cloud-to-browser RPC handshakes.",
        after: "Sub-12ms Native execution. Direct GPU-to-Terminal command bridge.",
        icon: ZapIcon
    }
];
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center mb-32 space-y-6">
                    ...
                    <h2 className="text-5xl md:text-8xl font-sans font-black text-white tracking-tighter leading-[0.9] uppercase">
                        The Workflow <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white/60 to-white/20">Transformation.</span>
                    </h2>
                </div>
