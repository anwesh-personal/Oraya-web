            ...
            >
                ...
                >
                    ...
                    <span className="text-[9px] md:text-[10px] font-mono font-black text-white/50 uppercase tracking-[0.5em] flex items-center gap-2">
                        {isRevealed ? "PROTOCOL: REVEALED" : "Sovereign_Node // RESONANCE"}
                ...
                >
                    A private neural interface for engineers.
                    <br className="hidden md:block" />
                    <span className="text-white font-normal mt-4 block text-base md:text-xl md:tracking-[0.1em]">Absolute hardware sovereignty. Zero context loss.</span>
                </motion.p>
