...
-- NOTE: Must use SECURITY DEFINER + SET search_path to include extensions,
-- because this trigger fires when GoTrue (supabase_auth_admin role) creates users,
-- and that role doesn't have 'extensions' (where pgcrypto/gen_random_bytes lives) 
-- in its default search_path.
